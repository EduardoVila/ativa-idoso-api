...
module CustomParseable
  ...
  # def parse_resumo_consultas_anteriores(essencials, object)
  ...
  # def parse_resumo_de_acoes_civeis(essencials, object)
  ...
  # def parse_relacao_de_acoes_civeis(essencials, object)
  ...
  # def parse_telefone_vinculado_documento_informado(essencials, object)
  ...
  # def parse_relacao_consultas_anteriores_credito_segmento(essencials, object)
  ...
  # def parse_participacoes_do_documento_consultado(essencials, object)
  ...
  # def parse_relacao_falencia_recuperacao_judicial(essencials, object)
  ...
  # def parse_outras_grafias(essencials, object)
  ...
  # def parse_status_consumidor(essencials, object)
  ...
  # def parse_painel_controle_positivo(essencials, object)
  ...
  # def parse_servicos_continuados(commitment_score)
  ...
  # def parse_operacoes_parceladas(commitment_score)
  ...
  # def save_summary_previous_query(
  #   register_size, register_type, register, document_type,
  #   document_number, total, initial_period, final_period,
  #   total_last_month, period, total_penultimate_month,
  #   penultimate_month_period, anti_total_penultimate_month,
  ...
  # def save_punctuality_note
  #   BoaVista::PunctualityNote.new({})
  # end

  # def save_continued_service
  #   BoaVista::ContinuedService.new({})
  # end

  # def save_credit_card_overdraft_and_other_revolving
  #   BoaVista::CreditCardOverdraftAndOtherRevolving.new({})
  # end

  # def save_installment_operation
  #   BoaVista::InstallmentOperation.new({})
  # end

  # def save_control_panel_item(description, value)
  ...
  # def save_commitment_score
  #   BoaVista::CommitmentScore.new({})
  # end

  # def save_positive_control_panel
  #   BoaVista::PositiveControlPanel.new({})
  # end

  # def save_consumer_status(message)
  #   BoaVista::ConsumerStatus.new({
  #                                    message: message
  #                                  })
  # end

  # def save_other_spelling(
  #   register_size, register_type, register, name, cpf, birth_date, rg,
  #   kind, street, number, complement, neighborhood, city, federal_unity,
  #   zip_code, ddd_1, phone_1, ddd_2, phone_2, ddd_3, phone_3
  # )
  ...
  # def save_relationship_judicial_recovery_bankruptcy(
  #   register_size, register_type, register, document_type,
  #   document_number, company_name, occurrence_type, registry,
  #   occurrence_date, praam, federal_unity, county_code
  # )
  ...
  # def save_participations_of_the_consulted_document(
  #   register_size, register_type, register, document_type_a,
  #   document_number_a, company_name, currency_type, value, observation,
  #   percentage_value, initial_date, role, document_type_b,
  #   document_number_b, partner_kind
  ...
  # def save_relation_of_previous_queries_credit_segment(
  #   register_size, register_type, register, document_type, document,
  #   occurrence_type, date, currency, value, informant, activity_branch,
  #   branch_description, group, group_description, segment,
  #   segment_description
  ...
  # def save_linked_phone_informed_document(
  #   register_size, register_type, register, ddd, phone, address,
  #   neighborhood, zip_code, city, federal_unit
  # )
  ...
  # def save_summary_of_civil_action(
  #   register_size, register_type, register, amount, initial_period,
  #   final_period
  # )
