...
module DataLoaders
  module BoaVista
    class Base
      def self.parse(cpf, credit_type, data)
      ...
      def self.parse_resumoConsultas_anteriores_90_dias(essencials, object)
      ...
      def self.parse_resumo_ocorrencias_de_debitos(essencials, object)
      ...
      def self.parse_informacoes_complementares(essencials, object)
      ...
      def self.parse_debitos(essencials, object)
      ...
      def self.parse_titulos_protestados(essencials, object)
        ...
        protested_titles.map! do |protested_title|
          ...
          protested_title = save_protested_title(
      ...
      def self.parse_resumo_titulos_protestados(essencials, object)
      ...
      def self.parse_cheque_talao_sustado(essencials, object)
      ...
      def self.parse_resumo_devolucoes_informadas_pelo_ccf(essencials, object)
      ...
      def self.parse_confirmacao_telefone(essencials, object)
      ...
      def self.parse_endereco_telefones_agencia_bancaria(essencials, object)
      ...
      def self.parse_confirmacao_cep(essencials, object)
      ...
      def self.parse_nome_documentos(essencials, object)
      ...
      def self.parse_relacao_devolucoes_informadas_pelo_ccf(essencials, object)
        ...
        list_of_returns_reported_by_ccfs.map! do |list_of_returns_reported_by_ccf|
          ...
          list_of_returns_reported_by_ccf = save_list_of_returns_reported_by_ccf(
            register_size, register_type, register, document_type, document_number,
      ...
      def self.parse_informacoes_complementares_cheque(essencials, object)
      ...
      def self.parse_devolucoes_informadas_pelo_usuario(essencials, object)
      ...
      def self.parse_cheques_sustados_pelo_motivo_21(essencials, object)
      ...
      def self.parse_historico_cheque_informado(essencials, object)
      ...
      def self.parse_historico_conta_corrente_informada(essencials, object)
      ...
      def self.parse_consultas_anteriores_cheque(essencials, object)
      ...
      def self.parse_resumo_devolucoes_informada_pelo_usuario(essencials, object)
      ...
      def self.parse_identificacao(essencials, object)
      ...
      def self.parse_localizacao(essencials, object)
      ...
      def self.parse_score_classificacao_varios_modelos(essencials, object)
        ...
        score_rating_several_models.map! do |score_rating_several_model|
          ...
          score_rating_several_model = save_score_rating_several_model(
      ...
      def self.parse_decisao(essencials, object)
      ...
      def self.parse_mensagem_registro(essencials, object)
      ...
      def self.parse_cartao_credito_cheque_especial_e_outros_rotativos(commitment_score)
        ...
        unless control_panel_items
          return credit_card_overdraft_and_other_revolving
        end
      ...
      def self.exception_handler(message)
        ...
        raise StandardError, "
                DataLoaders::BoaVista::Base exception code #{error_code}:
                #{error_message}
              "
      end

      def self.get_object(klass)
        model = klass.split('::').last

        Object.const_get("::BoaVista::#{model}").new
      end
    end
  end
end
