...
require 'spec_helper'
require 'helpers/pro_score/family_holding_helpers'
require_relative '../integrable'

RSpec.configure do |c|
  c.include FamilyHoldingHelpers, :family_holding_helpers
end

RSpec.describe ProScore::FamilyHoldingIntegrator,
               :family_holding_helpers do
    ...
    context 'when it is success' do
      ...
      it 'creates the report correctly' do
        ...
        expect { subject }.to change(ProScore::Report, :count).by(1)
          .and change(ProScore::FamilyHolding, :count).by(1)
      end
    end
