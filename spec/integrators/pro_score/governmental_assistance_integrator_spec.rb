...
require 'spec_helper'
require 'helpers/pro_score/governmental_assistance_helpers'
require_relative '../integrable'

RSpec.configure do |c|
  c.include GovernmentalAssistanceHelpers, :governamental_assistance_helpers
end

RSpec.describe ProScore::GovernmentalAssistanceIntegrator,
               :governamental_assistance_helpers do
    ...
    context 'when it is success' do
      ...
      it 'creates the report correctly' do
        ...
        expect { subject }.to change(ProScore::Report, :count).by(1)
          .and change(ProScore::FamilyAssistance, :count).by(1)
          .and change(ProScore::EmergencyAssistance, :count).by(1)
          .and change(ProScore::MonthlyBenefit, :count).by(1)
      end
    end
