...
require 'spec_helper'
require 'helpers/pro_score/bounced_check_helpers'
require_relative '../integrable'

RSpec.configure do |c|
  c.include BouncedCheckHelpers, :bounced_check_helpers
end

RSpec.describe ProScore::BouncedCheckIntegrator, :bounced_check_helpers do
    ...
    context 'when it is success' do
      ...
      it 'creates the report correctly' do
        ...
        expect { subject }.to change(ProScore::Report, :count).by(1)
          .and change(ProScore::BouncedCheck, :count).by(1)
      end
    end
