...
module CommercialRelationHelpers
  def success_body
    commercial_relation_response_path = File.join(
      __dir__,
      '..',
      '..',
      'fixtures',
      'pro_score',
      'commercial_relation_response.json'
    )

    File.read(commercial_relation_response_path)
  end
