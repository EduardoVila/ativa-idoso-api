...
module GovernmentalAssistanceHelpers
  def success_body
    governmental_assistance_response_path = File.join(
      __dir__,
      '..',
      '..',
      'fixtures',
      'pro_score',
      'governmental_assistance_response.json'
    )

    File.read(governmental_assistance_response_path)
  end
