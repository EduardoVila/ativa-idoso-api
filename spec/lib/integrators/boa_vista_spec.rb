...
RSpec.describe Integrators::BoaVista do
  ...
  #       body = described_class.build_completo_body_request(@cpf, @credit_type)
  ...
  #   context 'when request is a success' do
  #     let(:response_data) { described_class.acerta_positivo(@cpf, 'CC') }
  ...
  #       expect(log.method).to eq('post')
  #       expect(log.body).to eq(
  #         described_class.build_completo_body_request(@cpf, 'CC').to_s
  #       )
  #     end
  ...
  #   context 'when request returns empty body' do
  #     it 'raises EmptyResponseError' do
  #       allow(described_class).to receive(:acerta_positivo).with(@cpf, 'CC')
  #         .and_raise(EmptyResponseError.new)

  #       expect { described_class.acerta_positivo(@cpf, 'CC') }
  #         .to raise_error(EmptyResponseError)
  #     end
  #   end
  ...
  #     it 'retries 5 times, and then returns nil' do
  #       expect(described_class.acerta_positivo(@cpf, 'CC')).to eq(nil)
  #     end
  #   end
  # end
end
